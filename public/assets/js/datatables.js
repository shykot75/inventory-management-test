...
document.addEventListener('DOMContentLoaded', function () {
    ...
    new DataTable('#BCSDatatable', {
        ...
        dom:"<'grid grid-cols-12 lg:grid-cols-12 gap-3'" +
            ...
            "<'self-center col-span-12 md:col-span-6 lg:col-span-6 xl:col-span-6'l>" +  // Length changing input control on the left
            "<'self-center col-span-12 md:col-span-6 lg:col-span-6 xl:col-span-6 lg:place-self-end'f>" +  // Buttons and Filtering input control on the right
    ...
    $('#BCSExportBtnDatatable').DataTable({
        dom:"<'grid grid-cols-12 lg:grid-cols-12 gap-3'" +
            "<'self-center col-span-12'B>" +  // Buttons and Filtering input control on the right
