            ...
            <div class="grow-0 lg:grow w-full lg:w-fit py-4 lg:py-0 px-2">
                <div class="flex items-center justify-between lg:justify-end ml-0 lg:ml-6 gap-x-4">
                    ...
                    <button id="dark-mode-toggle"
                            class="px-2.5 py-1 rounded-full bg-white text-light dark:bg-dark dark:text-dark hover:bg-gray-200 hover:dark:bg-gray-700 hover:dark:text-white">
                        <i class="fa-solid fa-moon"></i>
                    </button>

                    <button type="button" id="notification-toggle"
                            class="relative px-1 py-1 rounded-full bg-white text-light dark:bg-dark dark:text-dark hover:bg-gray-200 hover:dark:bg-gray-700 hover:dark:text-white">
                    ...
                    <div class="relative ml-3">
                        <div>
                            <button type="button"
                                ...
                                <img class="h-8 w-8 rounded-full" src="{{ asset('assets/images/profile.png') }}" alt="">
                            </button>
                        </div>
                        ...
                        <div id="profile-dropdown"
                            ...
                            <a href="#!" class="flex gap-3 mb-3 border-b">
                                ...
                                <div>
                                    ...
                                    <p class="text-slate-500 dark:text-zinc-300 uppercase text-sm capitalize">{{ auth()->user()->role }}</p>
                                </div>
                            </a>
                            <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Your Profile</a>
                            <a href="./setting.html" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Settings</a>
                            <a href="#"
