...
<main class="pt-6 px-4 pb-6 text-light bg-primary-100 dark:bg-black dark:text-dark h-full overflow-y-auto">
    <div class="min-w-[calc(100vw - 4rem)] md:w-[30rem] lg:w-[35rem] bg-white card mx-auto drop-shadow-lg">
        <div class="flex flex-col justify-start items-center gap-4 py-12 px-6 relative lg:w-[25rem] mx-auto">
            ...
            <form action="../index.html" method="get" class="w-full">
                <div class="flex flex-col justify-start items-center space-y-2 w-full">
                    <div class="w-full">
                        ...
                        <div class="relative">
                            ...
                            <input type="email" id="username" class="ltr:pl-10 rtl:pr-10 form-input " placeholder="Enter your email">
                        </div>
                    </div>
                    <div class="w-full">
                        ...
                        <div class="relative">
                            ...
                            <input type="password" id="password" class="ltr:pl-10 rtl:pr-10 form-input " placeholder="Enter your email">
                    ...
                    <div class="w-full">
                        <div class="flex items-center justify-start text-left gap-2">
                            <input id="emailCheckRememberMe" class="border rounded-sm appearance-none size-4 bg-slate-100 border-slate-200 dark:bg-zinc-600 dark:border-zinc-500 checked:bg-primary-500 checked:border-primary-500 dark:checked:bg-primary-500 dark:checked:border-primary-500 checked:disabled:bg-primary-400 checked:disabled:border-primary-400" type="checkbox" value="1">
                    ...
                    <div class="w-full">
                        <button type="submit" class="btn w-full mt-6 bg-primary text-white font-medium text-lg">Sign in</button>
                    </div>
                </div>
            </form>
        </div>
